...
// Servo range
#define _DUTY_MIN 400    //[3148]  서보의 가동 최소 각도(0)
#define _DUTY_NEU 900      //[3150] servo neutral position (90 degree)
...
////////////////////
  ...
  // get a distance reading from the distance sensor
     dist_filtered = ir_distance();  // [3157] 적외선 선세로 측정한 값에 필터를 적용한 값
